...
def bubble_sort(draw_info, ascending = True):
    ...
    for i in range(len(lst) - 1):
        for j in range(len(lst) - 1 - i):
            ...
            if num1 > num2 and ascending or (num1 < num2 and not ascending): # Covers both ascending and descending
                lst[j] , lst[j + 1] = lst[j + 1], lst[j] # Swap the two values of the array
...
def insertion_sort(draw_info, ascending = True):
    ...
    for i in range(1, len(lst)):
        ...
        while True:
            ascending_sort = i > 0 and lst[i - 1] > current and ascending       # Assigns boolean value for whether the algorithm should continue
